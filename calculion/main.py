...
def main() -> None:
    ...
    with tab1:
        ...
        # st.write('## Introduction: Calculating the *Slow* Changes of Bioelectricity')
        ...
        st.write(
            f"Transmembrane electric potential, {l.Vmem}, plays a central "
            ...
            f"Well-known models of {l.Vmem} and its dynamics "
            ...
            f"However, these slowly changing ion "
        ...
        st.write(
            ...
            f"This model is the engine behind this web app."
        )

        st.write('### Usage')
        st.write(
            "* The **sidebar** to the left allows you to specify a variety of "
            "system parameters to build a bioelectrical system with different "
            "leak channel, ion pump, and transporter expression levels."
        )
        st.write(
            "* The **Simulation** tab explores the outcomes of different "
            "system properties from both a steady-state and dynamic perspectives."
        )
        st.write(
            "* The **System Insights** tab supplies "
            "explanations for the observed simulation results."
        )

        st.write('### See Also')
        st.write(
            "* A paper supplying the details of our model emphasizing the slow changes "
            "that shape the electrochemical ion gradients fundamental "
            "to bioelectricity will be available for download soon."
        )
        st.write(
